            ...
            <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    <h3 class="font-semibold text-4xl text-blueGray-700 text-center">
                        Listado de comidas por alumno
                    </h3>
                    <a href="<?php echo base_url(); ?>cook/attendance">
                        <div class="">
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $item) : ?>
                        <tr class="center-text">
                            ...
                            <td>
                                <!-- <a class="py-6" href="<?= base_url() ?>event/editar/<?= $item['id_children_cook'] ?>">
                                    <i class="fas fa-edit fa-fw me-3 text-primary"></i><span class="text-primary">
                                </a> -->
                                <a class="py-6" href="<?= base_url() ?>cook/attendance/borrar/<?= $item['id_children_cook'] ?>">
