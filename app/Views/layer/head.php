    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-warning">
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <a href="<?php echo base_url() ?>" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-chart-pie fa-fw me-3 text-white"></i><span class="text-white">Alumnos</span>
          </a>
          ...
          <a href="#" class="list-group-item list-group-item-action py-2 ripple color-change"><i class="fas fa-globe fa-fw me-3 text-white"></i><span class="text-white">Clases</span></a>
          <a href="#" class="list-group-item list-group-item-action py-2 ripple color-change"><i class="fas fa-building fa-fw me-3 text-white"></i><span class="text-white">Comidas</span></a>
          <a href="#" class="list-group-item list-group-item-action py-2 ripple color-change"><i class="fas fa-calendar fa-fw me-3 text-white"></i><span class="text-white">Maestros</span></a>
        </div>
      </div>
    </nav>
    <!-- Sidebar -->
