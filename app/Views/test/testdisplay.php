            ...
            <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    ...
                    <div class="grid gap-5">
                        <a href="<?php echo base_url(); ?>test/registrartest"
                    ...
                    <?php if(count($tests)>0): foreach ($tests as $test): ?>
                        <tr>
                            ...
                            <td class="text-center">
                               <a class="bg-green-500 text-blue-50 max-w-max shadow-sm hover:shadow-lg " href="<?= base_url() ?>test/testeditar/<?= $test['id_test'] ?>">Editar</a>
                               <a class="bg-red-500 text-blue-50 max-w-max shadow-sm hover:shadow-lg " href="<?= base_url() ?>test/testborrar/<?= $test['id_test'] ?>">eliminar</a>
                            </td>
                        </tr>
