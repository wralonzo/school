        ...
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    ...
                    <a href="<?php echo base_url(); ?>teacher/registrar">
                        <div class="">
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $item) : ?>
                        <tr class="center-text">
                            ...
                            <td>
                                <a class="py-6" href="<?= base_url() ?>teacher/editar/<?= $item['id_teacher'] ?>">
                                    <i class="fas fa-edit fa-fw me-3 text-primary"></i><span class="text-primary">
                                </a>
                                <a class="py-6" href="<?= base_url() ?>teacher/borrar/<?= $item['id_teacher'] ?>">
