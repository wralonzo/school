    ...
    <form method="POST" action="<?= base_url() ?>estudiante/registrar">
      <div id="main" class="grid grid-rows-4 grid-flow-col">
        <div class="relative w-full mb-2 px-5">
          ...
          <input type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="carnet" name="carnet" />
        </div>
        ...
        <div class="relative w-full mb-3 px-5">
          ...
          <input type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="semestre" name="semestre" />
        </div>
        <div class="relative w-full mb-3 px-5">
        ...
        <div class="relative w-full mb-3 px-5">
          ...
          <input type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="lugar" name="lugar" />
        </div>
      </div>
